    ...
    const exportToPDF = () => {
        ...
        transactions.forEach(tx => {
            const rowData = [
                ...
                typeof tx.details === 'object' ? JSON.stringify(tx.details) : tx.details
            ];
            ...
            <div className="dashboard-content fade-in">
                <div className="dashboard-header-responsive" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '2.5rem', flexWrap: 'wrap', gap: '1.5rem' }}>
                    ...
                    <button 
                        ...
                        style={{ padding: '0.75rem 1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem', borderRadius: '10px', fontWeight: '700' }}
                    >
