        ...
        <DashboardLayout>
            <div className="dashboard-content fade-in">
                <div className="dashboard-header" style={{ marginBottom: '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div>
                        <h1 style={{ fontWeight: '700', color: 'var(--color-primary)' }}>
                ...
                <div style={{ display: 'grid', gap: '1.25rem', gridTemplateColumns: 'repeat(12, 1fr)' }}>
                    ...
                    <div style={{ gridColumn: 'span 8' }}>
                        <div className="dash-card" style={{ 
                            ...
                            <div style={{ position: 'relative', zIndex: 1 }}>
                                ...
                                <h2 style={{ fontSize: '2rem', fontWeight: '800', marginBottom: '1.25rem', color: 'white' }}>₦0.00</h2>
                                <div style={{ display: 'flex', gap: '1rem' }}>
                                    <Link to="/dashboard/deposits" className="btn" style={{ background: 'white', color: 'var(--color-primary)', padding: '0.5rem 1.25rem', fontWeight: '700', borderRadius: '10px' }}>
                                        Deposit
                                    </Link>
                                    <button className="btn" style={{ background: 'rgba(255,255,255,0.15)', color: 'white', padding: '0.5rem 1.25rem', fontWeight: '700', borderRadius: '10px', backdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.2)' }}>
                                        Withdraw
                                    </button>
                                </div>
                            </div>
                    ...
                    <div style={{ gridColumn: 'span 12' }}>
                        <h3 style={{ fontSize: '1.1rem', fontWeight: '700', marginBottom: '1rem', color: 'var(--color-primary)' }}>Our Services</h3>
                    ...
                    <div style={{ gridColumn: 'span 12' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                            <h3 style={{ fontSize: '1.1rem', fontWeight: '700', color: 'var(--color-primary)' }}>Recent Activity</h3>
                            <Link to="/dashboard/transactions" style={{ fontSize: '0.85rem', color: 'var(--color-accent)', fontWeight: '700', textDecoration: 'none' }}>View All</Link>
                        </div>
                                            ...
                                            {transactions.map(tx => (
                                                <tr key={tx.id} style={{ borderBottom: '1px solid #F1F5F9' }}>
                                                    ...
                                                    <td style={{ padding: '0.75rem 1rem' }}>
                                                        <p style={{ fontWeight: '700', color: 'var(--color-primary)', marginBottom: '0.1rem', fontSize: '0.875rem' }}>{tx.type === 'deposit' ? 'Wallet Top-up' : tx.type}</p>
                                                    ...
                                                    <td style={{ padding: '0.75rem 1rem', textAlign: 'right' }}>
                                                        <p style={{ fontWeight: '800', color: 'var(--color-primary)', fontSize: '0.875rem' }}>₦{tx.amount.toLocaleString()}</p>
