                        ...
                        <div className="dash-card balance-card" style={{ 
                            ...
                            <div style={{ position: 'relative', zIndex: 1 }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.5rem' }}>
                                    ...
                                    <select value={currency} onChange={(e) => setCurrency(e.target.value)} style={{ padding: '0.1rem 0.3rem', borderRadius: '4px', border: '1px solid #e2e8f0', background: '#f8fafc', fontSize: '0.75rem', outline: 'none', cursor: 'pointer', color: 'var(--color-primary)' }}>
                                        <option value="NGN">NGN</option>
                                        <option value="USD">USD</option>
                                    </select>
                                    <button onClick={() => setIsBalanceVisible(!isBalanceVisible)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--color-text-secondary)', display: 'flex', alignItems: 'center', padding: 0 }} title="Toggle Balance Visibility">
                                        {isBalanceVisible ? (
