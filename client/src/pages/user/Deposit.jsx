        ...
        <DashboardLayout>
            <div className="dashboard-content fade-in" style={{ maxWidth: '1000px', margin: '0 auto' }}>
                <div className="dashboard-header" style={{ marginBottom: '1.5rem' }}>
                    ...
                    <p className="dashboard-subtitle" style={{ fontSize: '0.9rem', color: 'var(--color-text-secondary)' }}>
                ...
                {assets.length === 0 ? (
                    ...
                    <div style={{ 
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                            ...
                            {/* Modern Deposit Form */}
                            <div className="dash-card" style={{ padding: '1.5rem', border: 'none', boxShadow: '0 10px 30px rgba(0,0,0,0.04)' }}>
                                <div style={{ marginBottom: '1.25rem' }}>
                                    <h3 style={{ color: 'var(--color-primary)', fontSize: '1.1rem', fontWeight: '800' }}>1. Payment Details</h3>
                                    <p style={{ color: 'var(--color-text-secondary)', fontSize: '0.85rem' }}>Choose your asset and copy the destination address.</p>
                                </div>

                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
                                    <div className="form-group">
                                        <label style={{ fontSize: '0.8rem', fontWeight: '700' }}>Select Asset</label>
                                        <select 
                                            name="assetType" 
                                            value={formData.assetType} 
                                            onChange={handleAssetChange} 
                                            style={{ width: '100%', padding: '0.65rem', borderRadius: '8px', border: '1.5px solid var(--color-border)', outline: 'none', background: '#F9FAFB', fontWeight: '600', fontSize: '0.9rem' }}
                                        >
                                            {assets.map(a => (
                                    ...
                                    <div className="form-group">
                                        <label style={{ fontSize: '0.8rem', fontWeight: '700' }}>Network</label>
                                        <select 
                                            name="network" 
                                ...
                                <div style={{ 
                                    ...
                                    <label style={{ display: 'block', fontSize: '0.65rem', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.75rem', opacity: 0.7, fontWeight: '800' }}>
                                        Destination {formData.assetType} Address
                                    </label>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', position: 'relative', zIndex: 1 }}>
                                        <code style={{ fontSize: '0.95rem', wordBreak: 'break-all', fontWeight: '700', flex: 1, letterSpacing: '0.02em' }}>
                                            {getWalletAddress()}
                                        </code>
                                        <button 
                                ...
                                <div style={{ marginBottom: '1.25rem' }}>
                                    <h3 style={{ color: 'var(--color-primary)', fontSize: '1.1rem', fontWeight: '800' }}>2. Confirmation Form</h3>
                                    <p style={{ color: 'var(--color-text-secondary)', fontSize: '0.85rem' }}>Submit your transaction hash for verification.</p>
                                </div>
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="form-group" style={{ marginBottom: '1.25rem' }}>
                                        <label style={{ fontWeight: '700', marginBottom: '0.4rem', fontSize: '0.8rem' }}>Amount Sent (USD Value)</label>
                                        <div style={{ position: 'relative' }}>
                                            <span style={{ position: 'absolute', left: '0.875rem', top: '50%', transform: 'translateY(-50%)', color: 'var(--color-text-secondary)', fontWeight: '800', fontSize: '0.9rem' }}>$</span>
                                            <input 
                                                type="number" 
                                                name="amount" 
                                                ...
                                                placeholder="0.00" 
                                                required 
                                                style={{ width: '100%', padding: '0.75rem 0.75rem 0.75rem 1.75rem', borderRadius: '10px', border: '1.5px solid var(--color-border)', outline: 'none', background: '#F9FAFB', fontSize: '1rem', fontWeight: '700' }}
                                            />
                                        </div>
                                    </div>

                                    <div className="form-group" style={{ marginBottom: '1.25rem' }}>
                                        <label style={{ fontWeight: '700', marginBottom: '0.4rem', fontSize: '0.8rem' }}>Transaction Hash (TXID)</label>
                                        <input 
                                            type="text" 
                                            name="txHash" 
                                            ...
                                            required 
                                            style={{ width: '100%', padding: '0.75rem', borderRadius: '10px', border: '1.5px solid var(--color-border)', outline: 'none', background: '#F9FAFB', fontSize: '0.9rem' }}
                                        />
                                    </div>

                                    <div className="form-group" style={{ marginBottom: '2rem' }}>
                                        <label style={{ fontWeight: '700', marginBottom: '0.4rem', fontSize: '0.8rem' }}>Your Sending Wallet Address</label>
                                        <input 
                                            type="text" 
                                            name="fromAddress" 
                                    ...
                                    <button 
                                        ...
                                        disabled={submitting} 
                                        style={{ width: '100%', padding: '0.875rem', fontSize: '1rem', fontWeight: '800', borderRadius: '10px', boxShadow: '0 8px 16px rgba(56, 189, 248, 0.15)' }}
                                    >
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                            <div className="dash-card" style={{ padding: '1.5rem', border: 'none' }}>
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.5rem' }}>
                                    <h3 style={{ color: 'var(--color-primary)', fontSize: '1.1rem', fontWeight: '800' }}>Recent Deposits</h3>
                                    <button onClick={fetchData} style={{ background: 'none', border: 'none', color: 'var(--color-accent)', fontWeight: '800', cursor: 'pointer', fontSize: '0.8rem' }}>Refresh</button>
                                </div>
                                        ...
                                        {deposits.slice(0, 8).map((d) => (
                                            <div key={d._id} style={{ 
                                                ...
                                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                                                    ...
                                                    <div>
                                                        <div style={{ fontWeight: '800', fontSize: '0.875rem' }}>{d.assetType}</div>
                                                        <div style={{ fontSize: '0.7rem', color: 'var(--color-text-secondary)' }}>{new Date(d.createdAt).toLocaleDateString()}</div>
                                                    </div>
                                                </div>
                                                <div style={{ textAlign: 'right' }}>
                                                    <div style={{ fontWeight: '800', fontSize: '0.9rem', color: 'var(--color-primary)' }}>${d.amount.toLocaleString()}</div>
